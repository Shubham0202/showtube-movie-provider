...
<div class="show-alert">
 ...
 <div class='lang-container'>
        ...
        <a href="kdrama.php" class="langs active-lang">Drama</a>
...
<main class="container" id="containerr">
  ...
  <?php
    $sql= 'SELECT * FROM `webuploads` WHERE language LIKE "%kdrama%" ORDER BY `id` DESC';
    ...
    if($result_home)
    {
        while($row = mysqli_fetch_assoc($result_home))
        {
            ...
            $source=$row['source'];
            $ep1= $row['ep1'];
            $absolute_linkep1 = "https://".$_SERVER['HTTP_HOST'].$ep1;
            $ep2= $row['ep2'];
            $ep3= $row['ep3'];
            $ep4= $row['ep4'];
            $ep5= $row['ep5'];
              ...
              <div class="seasons">
                <div class="drop-down">
                  ...
                  <ul class="drop-menu drop-menu1">
                      <div class="half-part">
                          <li class="link-cover"><a href="'.$ep1.'"  class="ep-links">Episode1</a></li>
                          <li class="link-cover"><a href="'.$ep2.'"  class="ep-links">Episode2</a></li>
                          <li class="link-cover"><a href="'.$ep3.'"  class="ep-links">Episode3</a></li>
                          <li class="link-cover"><a href="'.$ep3.'"  class="ep-links">Episode4</a></li>
                      </div>
                      <div class="half-part">
                          <li class="link-cover"><a href="'.$ep5.'"  class="ep-links">Episode5</a></li>
                          <li class="link-cover"><a href="'.$ep6.'"  class="ep-links">Episode6</a></li>
                          <li class="link-cover"><a href="'.$ep7.'"  class="ep-links">Episode7</a></li>
                          <li class="link-cover"><a href="'.$ep8.'"  class="ep-links">Episode8</a></li>
                      </div>
                      <div class="half-part">
                          <li class="link-cover"><a href="'.$ep9.'"  class="ep-links">Episode9</a></li>
                          <li class="link-cover"><a href="'.$ep10.'" class="ep-links">Episode10</a></li>
                          <li class="link-cover"><a href="'.$ep11.'" class="ep-links">Episode11</a></li>
                          <li class="link-cover"><a href="'.$ep12.'" class="ep-links">Episode12</a></li>
                      </div>
                  </ul>
