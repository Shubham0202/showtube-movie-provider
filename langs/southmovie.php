...
<body>
    ...
    <div class='lang-container'>
        <a href="https://freemovie.showtube.live" class="langs ">All</a>
        <a href="southmovie.php" class="langs active-lang">SouthMovies</a>
    ...
    <main class="container" id="containerr">
        <div class="content-protector">
            <?php
            $sql = 'SELECT * FROM `upload_data` WHERE language LIKE "%southmovie%" ORDER BY `sr_no` DESC';
